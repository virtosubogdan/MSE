...
/**
 * The about the author dialog is a simple modal dialog box which displays
 * information about the people who wrote this utility.
 */
public class AboutTheAuthorDialog extends JDialog {
	...
	public AboutTheAuthorDialog(JFrame frame) {
		...
		m_panelConfirmation.setBorder(BorderFactory.createEmptyBorder(10, 10,
				10, 10));
